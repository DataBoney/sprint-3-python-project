...
for game in video_game_sales:
    running_total += game[GLOBAL_SALES]
avg_global_sales = ( running_total / total_games)
print(f"avg global sales {avg_global_sales}")

top_game_share = (video_game_sales[0][GLOBAL_SALES] / running_total) * 100
