...
# Write a for loop that counts how many games in the dataset were released before 2000. Store the count in a variable called pre_2000_count.
...
# Write a for loop that calculates the total North America sales and total Japan sales across all games.
america_sales = 0
japan_sales = 0
for game in video_game_sales:
    america_sales = america_sales + game[NA_SALES]
    japan_sales = japan_sales + game[JP_SALES]
print(america_sales)
print(japan_sales)
if america_sales > japan_sales:
    print('America Sales Higher', america_sales)
elif japan_sales > america_sales:
    print('Japan Sales Higher', japan_sales)
else:
    print('Both are equal in sales', america_sales)
